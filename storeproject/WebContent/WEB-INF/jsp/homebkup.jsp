					...
					<div class="row">
						<div class="col">
							<div
								...
								<nav class="main_nav">
									<ul>
										<li class="hassubs active"><a href="index.html">Home</a>
											<ul>
										...
										<!-- 							<select id="picksite" onchange="executelink()">
    <option value="">Pick A Website</option>
    <option value="google.do">Google</option>
    <option value="http://facebook.com">Facebook</option>
    <option value="http://twitter.com">Twitter</option>
    <option value="http://gmail.com">Gmail</option>
</select> 

										<li class="hassubs"><select class="hassubs" id="picksite"
											onchange="executelink()"><ul>
												<li><option value="#">Categories</option></li>
												<li><option value="smartphones.do">smartphones</option></li>
												<li><option value="laptops.do">laptops</option></li>
												<li><option value="harddiskes.do">harddiskes</option></li>
												<li><option value="poserbanks.do">powerbanks</option></li></ul>
										</select></li>
-->
										<li class="hassubs">
										<a href="#">Categories</a>
										<ul>
											<li><a href="Smartphones.do">Smartphones</a></li>
											<li><a href="Laptops.do">Laptops</a></li>
											<li><a href="Powerbanks.do">Powerbanks</a></li>
											<li><a href="categories.html">Harddisks</a></li>
											<li><a href="categories.html">Memorycards</a></li>
										</ul>
									</li>
					...
					<div class="col">
						<div class="avds_xl_container clearfix">
							<div class="avds_xl_background"
								style="background-image: url(images/avds_xl.jpg)"></div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#picksite").change(function() {
				...
				location = $newUrl;
				/* window.location.href=X+'/category/${publisher}'; */
